...
const AddExpenseModal: FC<AddExpenseModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className='fixed inset-0 z-50 flex items-center justify-center'>
      ...
      {/* Modal */}
      <div className='relative w-full max-w-4xl mx-4 max-h-[90vh] bg-surface border border-border rounded-xl shadow-2xl transform transition-all duration-300 scale-100'>
        {/* Header */}
          ...
          <div className='flex items-center gap-3'>
            ...
            <div>
              ...
              <p className='text-sm text-secondary'>
                Ghi lại chi tiêu một cách nhanh chóng và dễ dàng
              </p>
            </div>
          </div>
          <button
